...
SECRET_KEY = 'django-insecure-!lxus#39c9(38@j^fkkag&4jpr*b#(uln1xps(@5kkfm4p$agm'
...
# Simple JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # You can adjust the token expiration time
